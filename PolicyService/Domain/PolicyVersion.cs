...
public class PolicyVersion
{
    ...
    protected PolicyVersion()
    {
        Policy = null!;
        PolicyHolder = null!;
        CoverPeriod = ValidityPeriod.Between(DateTime.MinValue, DateTime.MinValue);
        VersionValidityPeriod = ValidityPeriod.Between(DateTime.MinValue, DateTime.MinValue);
    } //NH
